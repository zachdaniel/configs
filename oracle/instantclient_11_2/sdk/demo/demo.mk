...
ifeq ($(BUILD64),T)
CCFLAGS=$(CCINCLUDES) -DMAC_OSX -D_GNU_SOURCE -D_REENTRANT -g -m64 -mmacosx-version-min=10.6
LDFLAGS=-g -m64 -mmacosx-version-min=10.6
else
CCFLAGS=$(CCINCLUDES) -DMAC_OSX -D_GNU_SOURCE -D_REENTRANT -g -m32 -mmacosx-version-min=10.6
LDFLAGS=-g -m32 -mmacosx-version-min=10.6
endif
